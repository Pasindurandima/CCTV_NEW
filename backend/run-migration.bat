...
echo Connection details: Aiven MySQL Database (defaultdb)
%MYSQL_PATH% -h mysql-36042108-pasirandima2001-745a.c.aivencloud.com -P 28247 -u avnadmin -pAVNS_0t-CImdsGZPopmBRpRW --ssl-mode=REQUIRED defaultdb < add_multiple_images.sql
